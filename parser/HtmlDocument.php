...
include_once $_SERVER["DOCUMENT_ROOT"] . '/parser/constants.php';
include_once $_SERVER["DOCUMENT_ROOT"] . '/parser/HtmlNode.php';
include_once $_SERVER["DOCUMENT_ROOT"] . '/parser/Debug.php';
